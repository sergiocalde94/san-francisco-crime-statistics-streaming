...
PATH_RADIO_CODE = 'radio_code.json'
...
def run_spark_job(spark):
    ...
    kafka_df = df_streaming.selectExpr('CAST(value AS STRING)')

    service_table = (
        kafka_df
        .select(F.from_json(F.col('value'), SCHEMA).alias("value_str"))
        .select("value_str.*")
    )
    ...
    radio_code_json_filepath = PATH_RADIO_CODE
